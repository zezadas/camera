...
implements Parcelable.Creator<DataTypeCreateRequest> {
    static void a(DataTypeCreateRequest dataTypeCreateRequest, Parcel parcel, int n) {
        n = b.D(parcel);
    ...
    public DataTypeCreateRequest bF(Parcel parcel) {
        ...
        return new DataTypeCreateRequest(n2, string, arrayList);
    }

    public DataTypeCreateRequest[] cW(int n) {
