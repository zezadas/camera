...
extends IInterface {
    ...
    public static abstract class com.google.android.gms.drive.realtime.internal.e$a
    extends Binder
    implements e {
        ...
        public boolean onTransact(int n, Parcel object, Parcel parcel, int n2) throws RemoteException {
            switch (n) {
                ...
                case 1598968902: {
                    parcel.writeString("com.google.android.gms.drive.realtime.internal.ICollaboratorsCallback");
                    return true;
                }
                case 1: {
                    object.enforceInterface("com.google.android.gms.drive.realtime.internal.ICollaboratorsCallback");
                    this.a(object.createTypedArray(ParcelableCollaborator.CREATOR));
        ...
        implements e {
            ...
            @Override
            public void a(ParcelableCollaborator[] arrparcelableCollaborator) throws RemoteException {
                Parcel parcel = Parcel.obtain();
                Parcel parcel2 = Parcel.obtain();
                try {
                    parcel.writeInterfaceToken("com.google.android.gms.drive.realtime.internal.ICollaboratorsCallback");
                    parcel.writeTypedArray((Parcelable[])arrparcelableCollaborator, 0);
