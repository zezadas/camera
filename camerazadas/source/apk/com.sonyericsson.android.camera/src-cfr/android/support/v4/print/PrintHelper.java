...
public final class PrintHelper {
    ...
    implements PrintHelperVersionImpl {
        ...
        @Override
        public void printBitmap(String string, Bitmap bitmap) {
            this.mPrintHelper.printBitmap(string, bitmap);
        }

        @Override
        public void printBitmap(String string, Uri uri) throws FileNotFoundException {
            this.mPrintHelper.printBitmap(string, uri);
        }
    ...
    implements PrintHelperVersionImpl {
        ...
        @Override
        public void printBitmap(String string, Uri uri) {
        }
