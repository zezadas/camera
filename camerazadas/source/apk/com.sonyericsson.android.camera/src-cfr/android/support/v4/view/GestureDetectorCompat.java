...
public class GestureDetectorCompat {
    ...
    implements GestureDetectorCompatImpl {
        ...
        private void init(Context object) {
            ...
            int n = object.getScaledTouchSlop();
            int n2 = object.getScaledDoubleTapSlop();
            this.mMinimumFlingVelocity = object.getScaledMinimumFlingVelocity();
            this.mMaximumFlingVelocity = object.getScaledMaximumFlingVelocity();
        ...
        public boolean onTouchEvent(MotionEvent var1_1) {
            ...
            switch (var10_2 & 255) {
                ...
                case 0: {
                    ...
                    if (this.mDoubleTapListener != null) {
                        ...
                        if (this.mCurrentDownEvent != null && this.mPreviousUpEvent != null && var11_11 && this.isConsideredDoubleTap(this.mCurrentDownEvent, this.mPreviousUpEvent, var1_1)) {
                            ...
                            this.mHandler.sendEmptyMessageDelayed(3, GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT);
                            var6_3 = var7_4;
                        }
                    }
                    this.mLastFocusX = var3_5;
                    ...
                    return var6_3 | this.mListener.onDown(var1_1);
                }
                case 2: {
                    var12_12 = var11_11;
                ...
                case 1: {
                    this.mStillDown = false;
                    var15_15 = MotionEvent.obtain(var1_1);
...
lbl132: // 1 sources:
                    ...
                    var16_16.computeCurrentVelocity(1000, this.mMaximumFlingVelocity);
