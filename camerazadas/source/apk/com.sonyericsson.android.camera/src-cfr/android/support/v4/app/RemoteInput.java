...
extends RemoteInputCompatBase.RemoteInput {
    ...
    static {
        ...
        FACTORY = new RemoteInputCompatBase.RemoteInput.Factory(){
            ...
            @Override
            public RemoteInput build(String string, CharSequence charSequence, CharSequence[] arrcharSequence, boolean bl, Bundle bundle) {
                return new RemoteInput(string, charSequence, arrcharSequence, bl, bundle);
            }
    ...
    RemoteInput(String string, CharSequence charSequence, CharSequence[] arrcharSequence, boolean bl, Bundle bundle) {
